...
% -------------------------------------------------------------------------
% AMPLITUDE DEMODULATION PART 4: ELIMINATE JUMP
% GENERATE AN IMAGE WITH TOP HALF FROM FRAME 1 AND BOTTOM HALF FROM FRAME 3
% HERE, FV, FH, AND FV ARE MANUALLY ADJUSTED TO ELIMINATE THE JUMP
% -------------------------------------------------------------------------
...
colormap(gray)
title('Vertical Line Jump Eliminated: Top Half Frame 1, Bottom Half Frame 3')