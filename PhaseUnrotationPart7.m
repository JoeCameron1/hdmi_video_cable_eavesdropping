...
% -------------------------------------------------------------------------
% PHASE UNROTATION PART 7
% DISPLAY RGB AND HSV COLOUR COORDINATES IMAGES
% -------------------------------------------------------------------------
...
first_frame = iq_resampled(offset:offset+(fr/fv)-1);
...
title('First Frame where Red Channel = Real Part, Green Channel = Imaginary Part')
...
title('First Frame where Hue = Real Part, Value = Imaginary Part')
